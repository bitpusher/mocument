...
namespace MemoryMappedFileManager
{
    ...
    {
        static readonly MemoryMappedFileSecurity CustomSecurity;
        static MemoryMappedFileCommunicator()
        {
        ...
        public MemoryMappedFileCommunicator(string mapName, long capacity)
            : this(MemoryMappedFile.CreateOrOpen(mapName, capacity, MemoryMappedFileAccess.ReadWrite, MemoryMappedFileOptions.None, CustomSecurity, HandleInheritability.None), 0, 0, MemoryMappedFileAccess.ReadWrite)
        { }

        public MemoryMappedFileCommunicator(string mapName, long capacity, long offset, long size)
            : this(MemoryMappedFile.CreateOrOpen(mapName, capacity, MemoryMappedFileAccess.ReadWrite, MemoryMappedFileOptions.None, CustomSecurity, HandleInheritability.None), offset, size, MemoryMappedFileAccess.ReadWrite)
        { }

        public MemoryMappedFileCommunicator(string mapName, long capacity, long offset, long size, MemoryMappedFileAccess access)
            : this(MemoryMappedFile.CreateOrOpen(mapName, capacity, MemoryMappedFileAccess.ReadWrite, MemoryMappedFileOptions.None, CustomSecurity, HandleInheritability.None), offset, size, access)
        { }
